...
TodaysMR	<-	StreamflowFN(
		Depth				= 2010, 		# Average wshd soil depth (mm) 
		SATper				= 0.27 , 	# Porosity (fraction)	
...
# write.table(rbind(o1,o2,o3,o4,o5),file="sat_percent.js", quote=FALSE, col.names=FALSE, row.names=FALSE)
...
#cat(paste("var t = ", toJSON(data.frame(Date,Label,Today, Tomorrow, DayAfter, D3))), file="table.jsonp")
